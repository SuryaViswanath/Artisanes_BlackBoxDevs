  ...
  return (
    <div className="max-w-[1500px] mx-auto">
      ...
      <div className="flex max-w-2xl mx-auto mb-4">
        <label htmlFor="marketplace-search" className="sr-only">Search for products</label>
        <input
          ...
          className="flex-1 h-10 border border-border-input rounded-l rounded-r-none py-1 px-2 text-[15px] focus:outline-none focus:border-input-focus focus:shadow-input-focus"
          autoComplete="off"
        />
        <span className="h-10 w-[45px] bg-search-btn rounded-r flex items-center justify-center text-text-primary shrink-0">
      ...
      {filteredProducts.length === 0 ? (
        ...
        <>
          ...
          <div className="grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-2 mb-4" role="list">
